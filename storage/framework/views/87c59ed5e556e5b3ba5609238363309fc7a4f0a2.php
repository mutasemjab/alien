...
<form method="POST" action="<?php echo e(route('admin.settings.update')); ?>" enctype="multipart/form-data">
    ...
    <div class="form-grid">
      <div class="form-group">
        ...
        <input type="text" name="settings[site_name_en]"
               value="<?php echo e(old('settings.site_name_en', \App\Models\Setting::getValue('site_name_en', 'Alien Code'))); ?>">
      </div>
      <div class="form-group">
        <label>Site Name (Arabic) — اسم الموقع</label>
        <input type="text" name="settings[site_name_ar]"
               value="<?php echo e(old('settings.site_name_ar', \App\Models\Setting::getValue('site_name_ar', 'ألين كود'))); ?>"
               dir="rtl">
      </div>
      <div class="form-group full">
        <label>Site Logo</label>
        <?php $logo = \App\Models\Setting::getValue('logo'); ?>
        <?php if($logo): ?>
          <div style="margin-bottom:.8rem;">
            <img src="<?php echo e(asset('assets/admin/uploads/'.$logo)); ?>" style="height:44px;filter:drop-shadow(0 0 8px rgba(245,168,0,.4));">
          </div>
        <?php endif; ?>
      ...
      <div class="lang-panel active" data-lang="en">
        <div class="form-group">
          ...
          <input type="text" name="settings[meta_title_en]"
                 value="<?php echo e(\App\Models\Setting::getValue('meta_title_en', 'Alien Code — Next-Gen Software')); ?>">
        </div>
        <div class="form-group">
          <label>Meta Description (EN)</label>
          <textarea name="settings[meta_desc_en]" rows="2"><?php echo e(\App\Models\Setting::getValue('meta_desc_en')); ?></textarea>
        </div>
      </div>
      <div class="lang-panel" data-lang="ar">
        <div class="form-group">
          ...
          <input type="text" name="settings[meta_title_ar]"
                 value="<?php echo e(\App\Models\Setting::getValue('meta_title_ar', 'ألين كود — برمجيات الجيل القادم')); ?>"
                 dir="rtl">
        </div>
        <div class="form-group">
          <label>وصف الصفحة (AR Meta Description)</label>
          <textarea name="settings[meta_desc_ar]" rows="2" dir="rtl"><?php echo e(\App\Models\Setting::getValue('meta_desc_ar')); ?></textarea>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="form-grid">
      <div class="form-group">
        ...
        <input type="email" name="settings[contact_email]"
               value="<?php echo e(\App\Models\Setting::getValue('contact_email', 'hello@alien-code.io')); ?>">
      </div>
      <div class="form-group">
        <label>Support Phone</label>
        <input type="text" name="settings[contact_phone]"
               value="<?php echo e(\App\Models\Setting::getValue('contact_phone')); ?>">
      </div>
      <div class="form-group">
  ...
  <div class="card">
    ...
    <div class="form-grid">
      <?php $__currentLoopData = ['linkedin' => 'LinkedIn', 'facebook' => 'facebook', 'instagram' => 'instagram']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div class="form-group">
        <label><?php echo e($label); ?></label>
        <input type="url" name="settings[<?php echo e($key); ?>]"
               value="<?php echo e(\App\Models\Setting::getValue($key)); ?>"
               placeholder="https://...">
      </div>
      ...
      <div class="lang-panel active" data-lang="en">
        <div class="form-group">
          ...
          <input type="text" name="settings[about_title_en]"
                 value="<?php echo e(\App\Models\Setting::getValue('about_title_en', 'We Don\'t Write Code. We Write the Future.')); ?>">
        </div>
        <div class="form-group">
          <label>About Description (EN)</label>
          <textarea name="settings[about_desc_en]" rows="3"><?php echo e(\App\Models\Setting::getValue('about_desc_en')); ?></textarea>
        </div>
      </div>
      <div class="lang-panel" data-lang="ar">
        <div class="form-group">
          ...
          <input type="text" name="settings[about_title_ar]"
                 value="<?php echo e(\App\Models\Setting::getValue('about_title_ar')); ?>"
                 dir="rtl">
        </div>
        <div class="form-group">
          <label>وصف قسم من نحن (AR)</label>
          <textarea name="settings[about_desc_ar]" rows="3" dir="rtl"><?php echo e(\App\Models\Setting::getValue('about_desc_ar')); ?></textarea>
        </div>
      </div>
    </div>
  </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alien\resources\views/admin/settings/index.blade.php ENDPATH**/ ?>